...
<div class="card">
    <div class="card-body">
        {!! Form::open(['route'=>'admin.cordon.store','name'=>'cordon']) !!}
                ...
                <div class="form-group">
                  {!! Form::label('status2', 'Estado') !!}
                  {!! Form::select('status2',$status,null, ['class'=>'form-control']) !!}
...
<script src="{{asset('js/app.js')}}"></script>
      ...
      <script src="{{asset('vendor/geoserver-gis/geoserver-GetFeature-Calles.js')}}"></script>
